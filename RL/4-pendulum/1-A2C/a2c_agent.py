    ...
    def train(self, max_episode_num):
        ...
        for ep in range(int(max_episode_num)):
            ...
            while not done:
                ...
                v_value = self.critic.model.predict(tf.convert_to_tensor(state, dtype=tf.float32))
                next_v_value = self.critic.model.predict(tf.convert_to_tensor(next_state, dtype= tf.float32))
