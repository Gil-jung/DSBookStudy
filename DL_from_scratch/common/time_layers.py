...
class LSTM:
    def __init__(self, Wx, Wh, b):
        '''
        :param Wx: 입력 x에 대한 가중치 매개변수(4개분의 가중치가 담겨 있음)
        :param Wh: 은닉 상태 h에 대한 가중치 매개변수(4개분의 가중치가 담겨 있음)
        :param b: 편향（4개분의 편향이 담겨 있음）
        '''
        self.params = [Wx, Wh, b]
        self.grads = [np.zeros_like(Wx), np.zeros_like(Wh), np.zeros_like(b)]
        self.cache = None
...
class GRU:
    def __init__(self, Wx, Wh):
        '''
        :param Wx: 입력 x에 대한 가중치 매개변수(3개 분의 가중치가 담겨 있음)
        :param Wh: 은닉 상태 h에 대한 가중치 매개변수(3개 분의 가중치가 담겨 있음)
        '''
